...
<div id="songs-container" class="row">
    ...
    <div class="song-img">
        <img src="../<?php echo $data["song_image"]; ?>" width="250" height="750" alt="song">
    </div>
    ...
    <div class="song-details">
        ...
        <div class="music-player">
            ...
            <div class="play-song mouse">
                ...
                <source src="../<?php echo $data["song_file"];?>" type="audio/mp3">
                </audio> 
            </div>
            <div class="download-song mouse">
    <a href="../<?php echo $data["song_file"]; ?>" download="<?php echo $data["song_name"]; ?>">
